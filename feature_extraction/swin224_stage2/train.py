...
if __name__ == '__main__':
    ...
    parser.add_argument('--margin', default=0.15, type=float, help='margin of m for triplet loss')
    parser.add_argument('--recalls', default='1,2,4,8', type=str, help='selected recall')
    parser.add_argument('--batch_size', default=72, type=int, help='train batch size')
    parser.add_argument('--num_epochs', default=10, type=int, help='train epoch number')  # 50轮就差不多了
    ...
    model = Model(backbone_type, gd_config, feature_dim, num_classes=6000).cuda()
    model.load_state_dict(torch.load('../swin224_stage1/results/car_uncropped_resnet50_SM_512_0.1_0.5_0.15_88_model.pth'),strict=False)
